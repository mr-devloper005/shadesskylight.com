...
export const editableRootStyle = {
  '--slot4-page-bg': '#f6f8f7',
  '--slot4-page-text': '#071a2d',
  '--slot4-panel-bg': '#eef4f2',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#516176',
  '--slot4-soft-muted-text': '#7b8797',
  '--slot4-accent': '#185d63',
  '--slot4-accent-fill': '#185d63',
  '--slot4-accent-soft': '#dff0ee',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#103f45',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e5ecea',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f0f5f3',
  '--slot4-lavender': '#ffffff',
  '--slot4-gray': '#eef4f2',
  '--slot4-body-gradient': 'radial-gradient(circle at 12% -10%, rgba(24,93,99,0.13), transparent 28%), linear-gradient(180deg,#f6f8f7 0%,#ffffff 55%)',
  '--editable-page-bg': '#f6f8f7',
  '--editable-page-text': '#071a2d',
  '--editable-container': '1520px',
  '--editable-border': '#dbe3e0',
  '--editable-nav-bg': '#185d63',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#ffffff',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#185d63',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#ffffff',
  '--editable-footer-text': '#071a2d',
} as CSSProperties
